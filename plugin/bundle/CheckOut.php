<div class="collapse" id="ResellerCheckout">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="invoice-head">
                    ...
                    <p>Invoice Number : <?php echo $rspoid ?></p>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="invoice-info">
                    <strong class="customer-text-one">Customer Details</strong>
                    <h6 class="invoice-name"><?php echo $_SESSION['new_customer_name'] ?></h6>
                    <p class="invoice-details">
                      <?php echo $_SESSION['new_mobile_number'] ?> <br>
                      <?php echo $_SESSION['new_email'] ?> <br>
                      <?php echo $_SESSION['new_address'] ?> <br>
                      <?php echo $_SESSION['new_country'] ?> <br>
                      <?php echo $_SESSION['new_state'] ?> <br>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-12">
                <div class="form-group">
                  ...
                  <select name="paymentMethod" id="paymentMethod" class="form-control select2">
                    ...
                    <?php 
                    $country = $_SESSION['new_country'] ?? ''; // Handle case where session might not be set
...
<script>
  $(document).ready(function() {
    ...
    function fetchInvoiceData() {
      let poid = "<?php echo $rspoid; ?>"; // Get POID from PHP

      $.ajax({
        url: 'backend/bundle/checkoutInfo',
        type: 'GET',
        data: { poid: poid },
        dataType: 'json',
    ...
    function calculateShippingFee() {
      let poid = "<?php echo $rspoid; ?>"; // POID for shipping fee calculation

      $.ajax({
        url: 'backend/bundle/shippingFee', // Backend endpoint for calculating shipping fee
        type: 'POST',
        data: { poid: poid },
        dataType: 'json',
        success: function(response) {
    ...
    $('#purchaseButton').click(function(e) {
      ...
      $.ajax({
        url: 'backend/bundle/checkoutProcess', // Make sure this is the correct PHP file to handle the form
        type: 'POST',
        data: formData,
        contentType: false,
        processData: false,
